...
const Hero = () => {
  return (
    <section
      id="hero"
      className="home py-5 md:py-0 bg-hero-pattern bg-cover bg-no-repeat md:min-h-[calc(100vh_-_84px)] flex-col justify-between items-center relative shadow-2xl shadow-[0_0_10px_rgba(0,0,0,.09);] ps-[15%] md:ps-[13%] "
    >
      <LeftSideBarPattern />
      <div className="container max-w-[1200px] mx-auto ">
        <div className="sm:max-w-xl lg:max-w-3xl flex flex-col gap-y-6">
